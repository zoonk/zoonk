...
This is an internal package used by other packages. It shouldn't be imported directly by apps. Use `@zoonk/core/auth` instead.
...
To update better-auth schemas, run the following command from the root of the monorepo:
