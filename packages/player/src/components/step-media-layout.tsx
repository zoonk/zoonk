 ...
 * mobile and centered beside it on desktop. The desktop copy column reserves
 * room for both the question and next buttons so the floating controls never
 * cover the text.
 */
export function StepMediaLayout({
  ...
  return (
    ...
    >
      ...
      <div
        className="bg-background max-h-[45dvh] min-h-0 overflow-y-auto overscroll-contain px-4 py-4 sm:px-6 sm:py-6 lg:flex lg:max-h-none lg:items-center lg:justify-center lg:py-10 lg:pr-36 lg:pl-12"
