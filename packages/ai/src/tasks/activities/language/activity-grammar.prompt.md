...
The highlight should isolate the grammatical element:

- For verb conjugations: highlight the verb form (e.g., "habla", "parle", "spricht")
- For word order: highlight the word or phrase that demonstrates position
- For particles: highlight the particle (e.g., "wa", "ga", "ni" in Japanese)
- For agreement: highlight both agreeing elements (e.g., "la casa blanca")
