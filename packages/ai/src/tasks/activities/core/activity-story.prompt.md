...
Use `CONCEPTS` as your scope boundary and avoid teaching any `NEIGHBORING_CONCEPTS`. The story should help learners apply this lesson's concepts in realistic decisions.
