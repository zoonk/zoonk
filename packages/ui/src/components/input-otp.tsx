...
type InputOTPProps = React.ComponentProps<typeof OTPInput> & { containerClassName?: string };
...
export { InputOTP, InputOTPGroup, InputOTPSeparator, InputOTPSlot, type InputOTPProps };
