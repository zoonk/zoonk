 ...
 *
 * This is a workaround for next.js route caching, which preserves a route's state:
 ...
 * preventing stale preserved state from flashing the element on back-navigation.
 */
