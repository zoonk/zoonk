 ...
 * sentence-level variants from vocabulary data. Defined independently from
 * VocabularyWord since alternative translations are now generated by a
 * separate enrichment step and live only in the database.
 */
