...
- Usage data like lessons completed, answers, time spent, and device info.
...
- We use Google Ads conversion tracking to measure whether ads lead to subscriptions. Google may use cookies or similar technologies for this measurement.
