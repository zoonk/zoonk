...
import { useInvestigationPhaseGenerators } from "./phase-thinking-generators/investigation";
 ...
 *
 * Each domain (language, content, investigation) has its own file
 * in the phase-thinking-generators/ folder. This hook composes them.
 */
export function usePhaseThinkingGenerators(): Partial<Record<PhaseName, ThinkingMessageGenerator>> {
  return {
    ...
    ...useInvestigationPhaseGenerators(),
  };
}
