...
test.describe("Level Page", () => {
  ...
  test.describe("Authenticated Users", () => {
    ...
    test("displays total BP and current belt level", async ({ authenticatedPage }) => {
      ...
      await expect(authenticatedPage.getByText(/total brain power/i).first()).toBeVisible();

      await expect(authenticatedPage.getByText(/bp/i).first()).toBeVisible();

      await expect(authenticatedPage.getByText(/orange belt - level/i)).toBeVisible();
    ...
    test("displays belt progression visualization", async ({ authenticatedPage }) => {
      ...
      await expect(authenticatedPage.getByText(/belt progression/i)).toBeVisible();
