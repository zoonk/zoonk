  ...
  test("shows generation UI and completes workflow", async ({
    ...
    await setupMockApis(userWithoutProgress, {
      streamMessages: [
        ...
        { status: "started", step: "saveExplanationActivity" },
        { status: "completed", step: "saveExplanationActivity" },
      ],
    });
  ...
  test("completes workflow for practice activity kind", async ({
    ...
    await setupMockApis(userWithoutProgress, {
      streamMessages: [
        ...
        { status: "started", step: "savePracticeActivity" },
        { status: "completed", step: "savePracticeActivity" },
      ],
    });
  ...
  test("completes workflow for challenge activity kind", async ({
    ...
    await setupMockApis(userWithoutProgress, {
      streamMessages: [
        ...
        { status: "started", step: "saveChallengeActivity" },
        { status: "completed", step: "saveChallengeActivity" },
      ],
    });
  ...
  test("completes workflow for custom activity kind", async ({
    ...
    await setupMockApis(userWithoutProgress, {
      streamMessages: [
        ...
        { status: "started", step: "generateImages" },
        { status: "completed", step: "generateImages" },
        { status: "started", step: "saveCustomActivity" },
        { status: "completed", step: "saveCustomActivity" },
      ],
    });
  ...
  test("completes workflow for vocabulary activity kind", async ({
    ...
    await setupMockApis(userWithoutProgress, {
      streamMessages: [
        ...
        { status: "started", step: "generateVocabularyPronunciationAndDistractorUnsafes" },
        { status: "completed", step: "generateVocabularyPronunciationAndDistractorUnsafes" },
        ...
        { status: "started", step: "saveWordAudioAndRomanization" },
        { status: "completed", step: "saveWordAudioAndRomanization" },
        { status: "started", step: "saveVocabularyActivity" },
        { status: "completed", step: "saveVocabularyActivity" },
      ],
    });
  ...
  test("completes workflow for grammar activity kind", async ({
    ...
    await setupMockApis(userWithoutProgress, {
      streamMessages: [
        ...
        { status: "started", step: "generateGrammarUserContent" },
        { status: "completed", step: "generateGrammarUserContent" },
        { status: "started", step: "saveGrammarActivity" },
        { status: "completed", step: "saveGrammarActivity" },
        { status: "started", step: "saveGrammarActivity" },
        { status: "completed", step: "saveGrammarActivity" },
      ],
    });
  ...
  test("completes workflow for reading activity kind", async ({
    ...
    await setupMockApis(userWithoutProgress, {
      streamMessages: [
        ...
        { status: "started", step: "generateSentenceWordMetadata" },
        { status: "completed", step: "generateSentenceWordMetadata" },
        { status: "started", step: "generateAudio" },
        { status: "completed", step: "generateAudio" },
        { status: "started", step: "saveSentenceAudioAndRomanization" },
        { status: "completed", step: "saveSentenceAudioAndRomanization" },
        { status: "started", step: "saveReadingActivity" },
        { status: "completed", step: "saveReadingActivity" },
      ],
    });
  ...
  test("completes workflow for listening activity kind", async ({
    ...
    await setupMockApis(userWithoutProgress, {
      streamMessages: [
        ...
        { status: "started", step: "saveListeningActivity" },
        { status: "completed", step: "saveListeningActivity" },
      ],
    });
