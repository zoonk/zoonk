defmodule Zoonk.Schemas.UserIdentity do
  ...
  """
  def changeset(user_identity, attrs, opts \\ []) do
    validate_identity = Keyword.get(opts, :validate_identity, true)
  ...
  defp validate_id(changeset, true), do: validate_id(changeset, get_field(changeset, :identity))
  defp validate_id(changeset, false), do: changeset
