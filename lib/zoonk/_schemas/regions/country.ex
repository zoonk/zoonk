defmodule Zoonk.Schemas.Country do
  @moduledoc """
  ...
  schema "countries" do
    ...
    belongs_to :region_data, Zoonk.Schemas.Region, foreign_key: :region_id
    belongs_to :subregion_data, Zoonk.Schemas.Subregion, foreign_key: :subregion_id

    has_many :states, Zoonk.Schemas.State
    has_many :cities, Zoonk.Schemas.City
  end
end
