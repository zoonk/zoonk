defmodule Zoonk.Orgs.OrgProfile do
  @moduledoc """
  Defines the `OrgProfile` schema.

  Every organization has a profile. This is separate from
  `Zoonk.Orgs.Org` to avoid mixing up an org's settings
  and information visible to org members.
